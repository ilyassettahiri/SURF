...
export const pageLinks = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Team', path: paths.eLearning.team },
      { title: 'Price', path: paths.eLearning.price },
...
export const navConfig = [
  ...
  { title: 'Prices & Packages', path: paths.eLearning.price },
  { title: 'About us', path: paths.eLearning.about },
  { title: 'Our Team', path: paths.eLearning.team },
